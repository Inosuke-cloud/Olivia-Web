  ...
  <div id="wrapper">
    ...
    <div id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li>
            <li>
                <a href="../stories-published.php" class="pl-4 onpage">Published Stories </a>
            </li>
            <li>
        ...
        <div class="container-fluid">
            ...
            <div class="row border-bottom shadow p-3 tops">
                ...
                <div class="col-4 text-right">
                    <button class="btn btn-primary font-weight-bold text-white" name="approve" form="story-approval" id="approve"> UPDATE !</button>
                </div>
            </div>
