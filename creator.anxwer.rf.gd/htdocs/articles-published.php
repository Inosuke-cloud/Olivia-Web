  ...
  <div id="wrapper">
    ...
    <div id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li>
                <a href="#"  class="pl-4 onpage">Published Articles </a>
            </li>
            <li>
            ...
            <div class="row shadow mt-3 tops list-data" >
                ...
                <table class="table " >
                    <thead>
                        ...
                        <th scope="col" class="col-2">Publish Date</th>
                        <th scope="col" class="col-7">Title</th>
                        <th scope="col" class="col-2">Handler</th>
                        </tr>
                    </thead>
                    <tbody >

                    <?php
                        include "pages/article-list.php";
                    ?>
